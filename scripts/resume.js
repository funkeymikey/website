...
resumeApp.controller("ResumeCtrl", [
  ...
  function ($scope, $timeout) {
    $scope.resume = {
      ...
      tagline:
        "A hands-on leader that loves every part of making good software.",
      links: [],
