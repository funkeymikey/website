export const resume = {
  ...
  about: {
    bio: "<p>Engineering leader with experience in engineering management, software architecture, and product delivery across startups and established SaaS businesses. Builds effective teams through coaching, clear priorities, and shared learning, partnering across engineering, design, and customer-facing teams to solve valuable customer problems. Combines technical depth with product judgment to improve delivery throughput, strengthen software quality, and turn business priorities into measurable outcomes, including a product launch that generated $2M in incremental revenue.</p>",
    contact: {
  ...
  workHistory: [
    {
      employerName: "AireXpert",
      employerWebsite: "https://www.airexpert.net/",
      employerLogo: "images/airexpert.svg",
      employerTagline: "Aircraft Maintenance Platform",
      includeInPrint: true,
      ...
      positions: [
        {
          ...
          endDate: "2026-09-01",
          responsibilities: [
            "Owned delivery across a seven-person engineering, design, and QA team, setting priorities, assigning work, and taking responsibility for outcomes while balancing full-time and part-time capacity.",
            "Established a collaborative product planning process in the absence of a dedicated product manager, partnering with sales, delivery, and account management to clarify needs, align priorities, and define scope for phased releases.",
            "Directly managed the full-time engineers, including performance conversations and day-to-day people management.",
            "Shifted the team’s focus from individual utilization to delivery throughput, using vertical slicing and reduced work in progress to finish smaller increments and deliver customer value sooner.",
            "Replaced large batch releases with independent, zero-downtime deployments, using feature flags and automated release validation to support faster delivery with fewer user-reported bugs.",
            "Implemented automated GitHub Copilot code reviews and refined review instructions using feedback from senior engineers.",
            "Published a public product roadmap and authored release notes used by sales and account management in customer conversations, earning positive feedback for clearly communicating product improvements and delivery plans.",
          ],
          recognitions: [],
        },
      ],
      ...
      positions: [
        {
          ...
          responsibilities: [
            ...
            "Designed and implemented cloud architecture: AWS (ECR, RDS, Lambda, App Runner), Node.js/TypeScript, Postgres, Next.js, OpenTofu.",
      ...
      positions: [
        {
          ...
          endDate: "2025-06-01",
          responsibilities: [
            "Launched a product within nine weeks of joining that grew to 1,000+ monthly users and generated $2M in incremental revenue.",
            "Increased recruiter productivity 3x on a platform processing 500,000+ jobs, delivering tooling praised by experienced recruiters as best-in-class.",
            "Refocused an over-scoped product into an MVP, combining outcome-driven prioritization, early wireframing, and incremental delivery; used adoption scorecards to guide subsequent product decisions.",
            "Recruited, coached, and performance-managed a cross-functional team, establishing career development plans and a team book club to support shared learning and continuous improvement.",
            "Integrated AI-driven data cleansing through the ChatGPT API to normalize and validate recruiter and job data, eliminating manual cleanup and improving data quality.",
            "Established AWS infrastructure, automated testing, and GitHub Actions deployment pipelines to support frequent, low-risk releases.",
          ],
          recognitions: [],
        },
      ],
