...
resumeApp.controller("ResumeCtrl", [
  ...
  function ($scope, $timeout) {
    $scope.resume = {
      ...
      about: {
        bio: "<p>Mike is an engineering manager with extensive experience leading cross-functional teams to deliver high-impact software solutions. Successfully launched a product that achieved 1,000+ monthly users and generated $2M in revenue. Expert in agile methodologies, engineering leadership, cloud architecture, and value alignment. Committed to fostering team growth and continuous improvement to drive organizational success.</p><p>In his free time, he's rarely on a computer. He's usually at the zoo or museum with his kids &mdash; but if it's nice out, he's probably enjoying a park, or biking, or hiking in the Adirondack Mountains. His favorite NP complete problem is finding the most efficient way to load the dishwasher.  He's also really good at eating cookies.</p>",
        contact: {
          ...
          positions: [
            {
              ...
              responsibilities: [
                ...
                "Brought technical proficiency to a jobs platform that processed over 500,000 jobs and increased recruiter productivity 3x.",
                ...
                "Led UX process improvements by introducing wireframing-first then just-in-time design, which enhanced team collaboration and reduced design rework, resulting in faster project completion times",
                "Recruited and built a high-performing, cross-functional development team focused on delivering a user-centered, value-driven product, improving customer satisfaction and engagement.",
                "Championed a product-first mindset by prioritizing features based on impact and value, leading to more efficient resource allocation and increased product adoption.",
                "Implemented a weekly scorecard to track usage and adoption metrics, providing data-driven insights to inform product decisions and increase cross-functional communication.",
                "Integrated AI-driven data cleansing using the ChatGPT API, automating normalization and validation of recruiter and job data, which eliminated manual cleanup and improved data quality across the platform.",
                "Mentored developers and designers on cross-functional, incremental delivery, which improved team efficiency and accelerated project timelines.",
                ...
                "Performance management of the team, including goal setting, feedback, and career development.",
              ],
              recognitions: [],
            },
          ],
          ...
          positions: [
            {
              ...
              responsibilities: [
                ...
                "Facilitated stand-ups and retrospectives, enhancing team communication and project alignment.",
                "Iterated on SDLC and production change policies to find increase efficiencies.",
                "Designed wireframes for new feature proposals, aiding in clearer communication of ideas to stakeholders.",
                "Led weekly leadership meetings to report technology department status and needs, contributing to informed decision-making.",
                ...
                "Prioritized and defined tasks using agile methodologies, enhancing project efficiency.",
                ...
                "Hand-on coding for a back end API written in Python, built on top of FastAPI.",
                "Built end to end tests of said api using Tox.",
                "Managed infrastructure as code (IaC) in Google Cloud using Terraform.",
                "Performed data loading and analysis in Big Query as part of the methodology refinement.",
                "Managed Postgres database and versioning with SQLAlchemy and Alembic, ensuring data integrity and seamless updates.",
                "Conducted Big Data analysis using Pandas to identify trends in sports sponsorship, our core product.",
              ],
              recognitions: [],
            },
          ],
          ...
          positions: [
            {
              ...
              responsibilities: [
                ...
                "Architected solution to expand on legacy codebase and bring in modern benefits such as separate deployable services, quicker releases, automated testing, etc.",
              ],
              recognitions: [],
              technologies: [],
            },
